...
const Profile = () => {
  ...
  return (
    <div>
      <div className="container  h-full w-1/4  font-mono absolute -z-10   text-gray-700  p-7 text-md right-0">
        ...
        <div className="justify-center flex p-7">
          <img
            className="w-40 h-40 object-cover rounded-full justify-center items-center"
            src="https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8NXx8cHJvZmVzc2lvbmFsfGVufDB8fDB8fA%3D%3D&w=1000&q=80"
            alt=""
          />
        </div>
        ...
        <div className="py-3 text-red-600 flex text-sm gap-2 justify-center">
          ...
          <button className="bg-red-100 rounded-lg px-5 py-2">Block</button>
        </div>
      </div>
    </div>
  );
